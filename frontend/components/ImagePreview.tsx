  ...
  return (
    <div className="w-full rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 p-4 sm:p-6 shadow-sm">
      <div className="flex flex-col sm:flex-row items-center gap-6">
        {/* Preview thumbnail */}
        <div className="relative h-48 w-48 sm:h-40 sm:w-40 shrink-0 overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800 bg-black/95 flex items-center justify-center">
        ...
        <div className="flex-1 w-full text-center sm:text-left">
          ...
          <div className="mt-4 flex items-center justify-center sm:justify-start gap-3">
            ...
            <button
              onClick={onRemove}
              disabled={disabled}
              className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3 py-1.5 text-xs font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700/60 disabled:opacity-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
